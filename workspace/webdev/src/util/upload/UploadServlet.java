...
//		String uploadFilePath = context.getRealPath(savePath);
		String uploadFilePath = "C:/dev/upload";
//		"C:/dev/workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/webdev/upload";
...
//			multi.getContentType("uploadFile");
			...
			isImage = multi.getContentType("uploadFile").substring(0, 6).toLowerCase().equals("image/");
			
			String ext = multi.getContentType("uploadFile").substring(6).toLowerCase();
			...
			if (fileName == null) {
				...
				out.println("<br> 퍄일명 : <a href='download.do?filename=" + fileName + "'>" +  fileName + "</a>");
				if (isImage) {
					out.println("<hr/>");
					out.println("<br/><img src='download.do?filename=" + "/thumb_" + fileName + "' />");
					out.println("<br/><img src='download.do?filename=" + fileName + "' />");
				}
			}
