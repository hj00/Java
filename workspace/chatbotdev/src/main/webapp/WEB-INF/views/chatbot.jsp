...
function ajax_process(_isay) {
	$.ajax({
		...
		success : function(data) {
			...
			if (_isay === '') {
				watsonsay += '<br/><img src="<c:url value="/resources/img/d5598ad581ef4282f8f8276781bea001.jpg" />" width="300" />';
			}
...
<body>
<div id="said"></div>
<input type="text" id="text_isay" class="triangle-border center"/>
