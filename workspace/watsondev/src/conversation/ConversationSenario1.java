...
public class ConversationSenario1 {
	public static void main(String[] args) {
		...
		System.out.println("저희 메뉴는 엔원오리지널, 엔원허니콤보, 엔원레드콤보가 있습니다.");
		String input = null;
		do {
		...
		System.out.println("음료 또는 사이드 메뉴를 추가하시겠습니까? > ");
		input = sc.nextLine().trim();
...
/*		if (input.equals("예")) {
		...
		System.out.println("도착 예상 시간은 " + ca.get(Calendar.HOUR_OF_DAY) + "시" + ca.get(Calendar.MINUTE) + "분 입니다.");
		sc.close();
	}
